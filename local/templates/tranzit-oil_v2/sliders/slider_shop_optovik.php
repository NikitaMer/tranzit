...
if($is_shop_main)
{
    ...
    <div id="main-slider-navigation" class="navigation2 wrapper center-block">
        ...
        <ul class="tabs2">
            <li>
              <a  href="/shop/o-magazine/o-magazine.php" class="line"><div class="icon"></div>Об интернет<br> магазине</a>
            </li>
            <li>
                <a  href="/shop/oplata-i-dostavka/" class="line"><div class="icon"></div>Оплата и<br>доставка</a>
            </li>
            <li>
                <a href="/shop/action/" class="line"><div class="icon"></div>Наши <br>акции</a>
            </li>
            <li>
                <a href="/shop/otzyvy/" class="line"><div class="icon"></div>Отзывы о<br> магазине</a>
            </li>
            <li>
              <a href="/shop/kontakty-internet-magazina" class="line"><div class="icon"></div>Контактная<br> информация</a>
            </li>
        </ul>
