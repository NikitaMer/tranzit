...
<?
    ...
    <div class="col main_right">
        ...
        <?// Отображение фильтра "Подобрать по автомобилю"?>
        <? if (!preg_match("/produkty-pitaniya/i", $arResult["VARIABLES"]["SECTION_CODE_PATH"])) { $APPLICATION->IncludeComponent("conf:form_wide"); } ?>
