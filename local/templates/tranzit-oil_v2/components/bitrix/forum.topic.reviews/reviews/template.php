...
?>
<style>
.reviews-block-container {margin-bottom: 20px;}
table.reviews-post-table thead td{background: #fff; text-align: left;}
table.reviews-post-table tbody td{background: #fff; text-align: left;}
</style>
