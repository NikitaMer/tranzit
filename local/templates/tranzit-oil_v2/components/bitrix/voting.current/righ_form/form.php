...
<div class="interview">
	...
	<div id="<?=$id?>_result" style="display:none;"><?
		?><?$APPLICATION->IncludeComponent("bitrix:voting.result", "right",
			Array(
				"VOTE_ID" => $arResult["VOTE_ID"],
				"CACHE_TIME" => $arParams["CACHE_TIME"],
				"PERMISSION" => $arParams["PERMISSION"],
	...
	<a class="link icon icon16 result" href="#">Результаты</a>
	<a class="link icon icon16 arhiv" href="#">Архив опросов</a>
