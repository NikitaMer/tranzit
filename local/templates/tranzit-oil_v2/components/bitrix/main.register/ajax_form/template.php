...
<?else:?>
    ...
    <div class="auth_form_registr <?=$theme?>">
        ...
        <?endforeach?>
			...
			<input type="radio" name="PERSON_TYPE" value="1" checked> Физическое лицо<br>
			<input type="radio" name="PERSON_TYPE" value="2" > Юридическое лицо<br><br>
			<div id="ur_block" style="display:none;">
				<div class="field login">
					<input size="30" type="text" name="REGISTER[PERSONAL_COMPANY]" value="" placeholder="Название организации/ИП">
				</div>
				<div class="field login">
					<input size="30" type="text" name="REGISTER[UF_INN]" value="" placeholder="ИНН">
				</div>
			</div>							
            <?
            // ******************** /User properties ***************************************************
