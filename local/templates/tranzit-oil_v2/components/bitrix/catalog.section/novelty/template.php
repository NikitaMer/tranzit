...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		$img = CFile::ResizeImageGet($pict, array('width'=>82, 'height'=>82), BX_RESIZE_IMAGE_PROPORTIONAL, true);
		?>
		<li id="<? echo $strMainID; ?>">
			<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="image" style="background-image: url(<?=$img['src'];?>)" title="<?=$imgTitle;?>"></a>
			<div class="desc">
				<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="catalog-name"><?=TruncateText($productTitle, 35);?></a>
